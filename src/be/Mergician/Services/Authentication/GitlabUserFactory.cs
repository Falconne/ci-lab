...
/// <summary>
///     Factory for creating AccessDetailsForUser instances for the service user.
...
public class GitlabUserFactory
{
    ...
    /// <summary>
    ///     Returns a AccessDetailsForUser for the configured service account.
    ...
    public AccessDetailsForUser GetServiceUser()
    {
        ...
        return new AccessDetailsForUser(_serviceToken!, _apiBaseUrl);
    }
}