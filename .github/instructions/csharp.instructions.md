...
# Web serivices specific guidelines
- Do not put business logic in controllers, use service classes called from controllers instead.

## Repository Specific Guidelines
- Use the helper methods in the Util project wherever possible to simplify code, particularly `IsEmpty`, `IsNotEmpty` and `NotAny`.
